...
export default function ResumeBuilder() {
  ...
  const [personalInfo, setPersonalInfo] = useState({
    ...
    email: 'learner@learnhub.com',
    github: 'github.com/learnhub-pro',
    linkedin: 'linkedin.com/in/learnhub'
  });
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
            <div>
              ...
              <p className="text-text-secondary mt-4 max-w-xl">
                One-click generation of professional resumes using your verified LearnHub progress, projects, and achievements.
              </p>
            </div>
            ...
            <div className="lg:col-span-2">
               <div className="bg-white rounded-lg shadow-2xl p-12 text-gray-800 min-h-[842px] relative">
                  ...
                  <div className="grid grid-cols-3 gap-12">
                     ...
                     <div className="col-span-2 space-y-10">
                        ...
                        <section>
                           ...
                           <div>
                              <h4 className="text-sm font-bold text-gray-900">LearnHub Advanced Certification</h4>
                  ...
                  <div className="absolute bottom-12 left-12 right-12 border-t border-gray-100 pt-4 flex justify-between items-center opacity-30">
                     <p className="text-[8px] font-bold uppercase tracking-widest italic">Generated by LearnHub Career Systems</p>
